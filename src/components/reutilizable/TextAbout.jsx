export default function TextAbout() {
  return (
    <div className="flex flex-col gap-y-2">
      <span className="span-about md:text-gray-200 text-lg">
      ...
      <span className="span-about text-lg text-red-500">
      ...
      <span className="span-about md:flex sm:hidden text-gray-200  text-lg">
