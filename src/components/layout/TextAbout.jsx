export default function TextAbout() {
  return (
    <div className="flex flex-col gap-y-2 md:mt-6 sm:mt-1 max-w-screen-xl">
      ...
      <span className="span-about text-lg text-green-200">
      ...
      <span className="span-about md:flex sm:hidden text-green-500 text-lg">
