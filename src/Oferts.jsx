...
export default function Oferts({
  ...
  return (
    <section className="grid grid-cols-2 w-full md:h-[25vh] sm:h-[45vh] relative">
      <Image
        src={src}
        width={900}
        height={50}
        className="object-center object-cover w-full md:h-[25vh] sm:h-[45vh] -z-10"
      />
      <div
      ...
      >
        <div>
          <h1 className="text-5xl font-extrabold text-[#FEFAE2]">{title}</h1>
